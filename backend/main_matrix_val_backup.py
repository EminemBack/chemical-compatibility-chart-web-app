...
def calculate_hazard_status(class_a: str, class_b: str, distance: float) -> tuple[str, bool, float]:
    ...
    compatibility_matrix = {
        ...
        ("2_flammable", "2_nonflammable"): (False, 3.0),  # OK to store together
        ("2_flammable", "2_toxic"): (False, 3.0),  # Segregate at least 3m
        ("2_flammable", "2_oxidizing"): (False, 3.0),  # Segregate at least 3m
        ("2_flammable", "3"): (False, 5.0),  # Segregate at least 5m
        ("2_flammable", "4_flammablesolid"): (False, 5.0),  # Segregate at least 3m
        ("2_flammable", "4_spontaneouslycombustible"): (False, 5.0),  # Segregate at least 3m
        ("2_flammable", "4_dangerouswhenwet"): (False, 5.0),  # Segregate at least 3m
        ("2_flammable", "5.1"): (False, 3.0),  # Segregate at least 3m
        ("2_flammable", "5.2"): (True, float('inf')),  # Isolate
        ("2_flammable", "6"): (False, 3.0),  # Segregate at least 3m
        ("2_flammable", "8"): (False, 5.0),  # Segregate at least 3m
        
        # Non-Flammable Non-Toxic Gas (Class 2)
        ("2_nonflammable", "2_nonflammable"): (False, 3.0),  # Same type
        ("2_nonflammable", "2_toxic"): (False, 3.0),  # OK to store together
        ("2_nonflammable", "2_oxidizing"): (False, 3.0),  # OK to store together
        ("2_nonflammable", "3"): (False, 5.0),  # OK to store together
        ("2_nonflammable", "4_flammablesolid"): (False, 5.0),  # OK to store together
        ("2_nonflammable", "4_spontaneouslycombustible"): (False, 5.0),  # OK to store together
        ("2_nonflammable", "4_dangerouswhenwet"): (False, 5.0),  # OK to store together
        ("2_nonflammable", "5.1"): (False, 3.0),  # Segregate at least 3m
        ("2_nonflammable", "5.2"): (True, float('inf')),  # Isolate
        ("2_nonflammable", "6"): (False, 3.0),  # Segregate at least 3m
        ("2_nonflammable", "8"): (False, 5.0),  # Segregate at least 3m
        
        # Toxic Gas (Class 2)
        ("2_toxic", "2_toxic"): (False, 10.0),  # Same type
        ("2_toxic", "2_oxidizing"): (False, 3.0),  # OK to store together
        ("2_toxic", "3"): (False, 5.0),  # Segregate at least 3m
        ("2_toxic", "4_flammablesolid"): (False, 5.0),  # Segregate at least 3m
        ("2_toxic", "4_spontaneouslycombustible"): (False, 5.0),  # Segregate at least 3m
        ("2_toxic", "4_dangerouswhenwet"): (False, 5.0),  # Segregate at least 3m
        ("2_toxic", "5.1"): (False, 3.0),  # Segregate at least 3m
        ("2_toxic", "5.2"): (True, float('inf')),  # Isolate
        ("2_toxic", "6"): (False, 3.0),  # Segregate at least 3m
        ("2_toxic", "8"): (False, 5.0),  # Segregate at least 3m
        
        # Oxidizing Gas (Class 2)
        ("2_oxidizing", "2_oxidizing"): (False, 3.0),  # Same type
        ("2_oxidizing", "3"): (False, 5.0),  # OK to store together
        ("2_oxidizing", "4_flammablesolid"): (False, 5.0),  # Segregate at least 3m
        ("2_oxidizing", "4_spontaneouslycombustible"): (False, 5.0),  # Segregate at least 3m
        ("2_oxidizing", "4_dangerouswhenwet"): (False, 5.0),  # Segregate at least 3m
        ("2_oxidizing", "5.1"): (False, 3.0),  # OK to store together
        ("2_oxidizing", "5.2"): (True, float('inf')),  # Isolate
        ("2_oxidizing", "6"): (False, 3.0),  # Segregate at least 3m
        ("2_oxidizing", "8"): (False, 5.0),  # Segregate at least 3m
        
        # Flammable Liquid (Class 3)
        ("3", "3"): (False, 3.0),  # Same type
        ("3", "4_flammablesolid"): (False, 3.0),  # OK to store together
        ("3", "4_spontaneouslycombustible"): (False, 5.0),  # OK to store together
        ("3", "4_dangerouswhenwet"): (False, 5.0),  # OK to store together
        ("3", "5.1"): (False, 5.0),  # Segregate at least 3m
        ("3", "5.2"): (True, float('inf')),  # Isolate
        ("3", "6"): (False, 3.0),  # Segregate at least 3m
        ("3", "8"): (False, 3.0),  # Segregate at least 3m
        
        # Flammable Solid (Class 4)
        ("4_flammablesolid", "4_flammablesolid"): (False, 3.0),  # Same type
        ("4_flammablesolid", "4_spontaneouslycombustible"): (False, 3.0),  # Same type
        ("4_flammablesolid", "4_dangerouswhenwet"): (False, 5.0),  # Same type
        ("4_flammablesolid", "5.1"): (False, 3.0),  # Segregate at least 3m
        ("4_flammablesolid", "5.2"): (True, float('inf')),  # Isolate
        ("4_flammablesolid", "6"): (False, 3.0),  # Segregate at least 3m
        ("4_flammablesolid", "8"): (False, 10.0),  # Segregate at least 3m
        
        # Spontaneously Combustible (Class 4)
        ("4_spontaneouslycombustible", "4_spontaneouslycombustible"): (False, 3.0),  # Same type
        ("4_spontaneouslycombustible", "4_dangerouswhenwet"): (False, 5.0),  # Same type
        ("4_spontaneouslycombustible", "5.1"): (False, 5.0),  # Segregate at least 3m
        ("4_spontaneouslycombustible", "5.2"): (True, float('inf')),  # Isolate
        ("4_spontaneouslycombustible", "6"): (False, 3.0),  # Segregate at least 3m
        ("4_spontaneouslycombustible", "8"): (False, 3.0),  # Segregate at least 3m
        
        # Dangerous When Wet (Class 4)
        ("4_dangerouswhenwet", "4_dangerouswhenwet"): (False, 3.0),  # Same type
        ("4_dangerouswhenwet", "5.1"): (False, 5.0),  # Segregate at least 3m
        ("4_dangerouswhenwet", "5.2"): (True, float('inf')),  # Isolate
        ("4_dangerouswhenwet", "6"): (False, 3.0),  # Segregate at least 3m
        ("4_dangerouswhenwet", "8"): (False, 5.0),  # Segregate at least 3m
        
        # Oxidizing Agent (Class 5.1)
        ("5.1", "5.1"): (False, 10.0),  # Same type
        ("5.1", "5.2"): (True, float('inf')),  # Isolate
        ("5.1", "6"): (False, 3.0),  # Segregate at least 3m
        ("5.1", "8"): (False, 3.0),  # Segregate at least 3m
        
        # Organic Peroxide (Class 5.2) - ISOLATE from all except Corrosive
        ("5.2", "5.2"): (False, 3.0),  # Same type
        ("5.2", "6"): (True, float('inf')),  # Isolate
        ("5.2", "8"): (False, 3.0),  # OK to store together
        
        # Toxic (Class 6)
        ("6", "6"): (False, 3.0),  # Same type
        ("6", "8"): (False, 10.0),  # OK to store together
        
        # Corrosive (Class 8)
        ("8", "8"): (False, 10.0),  # Same type
    }    
    ...
    name_to_class = {
        ...
        "Flammable Liquid": "3",
        "Flammable Solid": "4_flammablesolid",
        "Spontaneously Combustible": "4_spontaneouslycombustible",  # Treat as Class 4
        "Dangerous When Wet": "4_dangerouswhenwet",  # Treat as Class 4
        "Oxidizing Agent": "5.1",
